...
# plat1 = Platform(200, 200, 100, 30, "moving h")
# plat2 = Platform(250, 100, 100, 30, "normal")
# plat3 = Platform(50, 25, 100, 30, "moving h")
# plat4 = Platform(100, 200, 30, 100, "normal")
...
for i in range (0,10):
    m = Mob(randint(0,WIDTH), randint(0, HEIGHT), 25, 25, "attacking player horizontally")
    all_sprites.add(m)
    all_mobs.add(m)
